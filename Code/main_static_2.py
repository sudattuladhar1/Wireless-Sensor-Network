...
print 'Static_2: User-Defined-2 Type Link Program Started'

sensors = Sensors(scenario = 'STATIC_2')
...
sensors.savefig('./Results/Layout_Static_2_Route')
sensors.end()


print 'Static_2: User-Defined-2 Type Link Program Ended'
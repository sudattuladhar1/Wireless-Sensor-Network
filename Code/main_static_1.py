...
print 'Static_1: User-Defined-1 Type Link Program Started'

sensors = Sensors(scenario = 'STATIC_1')
...
sensors.savefig('./Results/Layout_Static_1_Route')
sensors.end()


print 'Static_1: User-Defined-1 Type Link Program Ended'